...
export class ComparableUtils {
    ...
    public static between<T>(b: T, c: T, compareTo: Comparator<T>): Predicate<T> {
        return a => this.betweenOrdered(a, b, c, compareTo) || this.betweenOrdered(a, c, b, compareTo);
    }
    ...
    public static betweenExclusive<T>(b: T, c: T, compareTo: Comparator<T>): Predicate<T> {
        return a => this.betweenOrderedExclusive(a, b, c, compareTo) || this.betweenOrderedExclusive(a, c, b, compareTo);
    }
