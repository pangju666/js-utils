...
export class RegexUtils {
    ...
    public static readonly ENGLISH_STR = /[\w\s`~!@#$%^&*()_\-+={}[\];:'"|/?,<>\\]*/;
    ...
    public static readonly CHINESE_STR = /[\u4e00-\u9fa5\\d\s·~！@#￥%…&*（）—+-=、|【】{}：；“‘/？。，《》]*/;

    /** 符号 */
    public static readonly SYMBOL = /[\s`~!@#$%^&*()_\-+={}[\];:'"|/?,<>\\]+/;
    /** 数字和符号 */
    public static readonly NUMBER_SYMBOL = /[\s\d`~!@#$%^&*()_\-+={}[\];:'"|/?,<>\\]+/;
    ...
    /** 电话 */
    public static readonly PHONE_NUMBER = /^(13[0-9]|14[0-1,4-9]|15[0-3,5-9]|16[2,5-7]|17[0-8]|18[0-9]|19[0-3,5-9])\d{8}$/;
    /** 身份证号码 */
    ...
    /** 电子邮箱, @前可存在中文 */
    public static readonly EMAIL = /[\u4e00-\u9fa5\w!#$%&'*+/=?^_`{|}~-]+(\.[\u4e00-\u9fa5\w!#$%&'*+/=?^_`{|}~-]+)*@([\w]([\w-]*[\w])?\.)+[\w]([\w-]*[\w])?/;
    /** URL */
    public static readonly URL = /[a-zA-Z]+:\/\/[-A-Za-z0-9+&@#/%?=~_|!:,.;]+[-A-Za-z0-9+&@#/%=~_|]+/;
    /** HTTP */
    public static readonly HTTP = /(HTTP|http)[sS]?:\/\/[-A-Za-z0-9+&@#/%?=~_|!:,.;]+[-A-Za-z0-9+&@#/%=~_|]+/;
    /** FTP */
    public static readonly FTP = /(FTP|ftp)[sS]?:\/\/[-A-Za-z0-9+&@#/%?=~_|!:,.;]+[-A-Za-z0-9+&@#/%=~_|]+/;
    /** FILE */
    public static readonly FILE = /(FILE|file):\/\/[-A-Za-z0-9+&@#/%?=~_|!:,.;]+[-A-Za-z0-9+&@#/%=~_|]+/;
    /** IPV4地址 */
    public static readonly IPV4_ADDRESS = /(\d{1,3}\.){3}\d{1,3}/;
    /** IPV6地址 */
    public static readonly IPV6_ADDRESS = /((([a-fA-F\d]{1,4}:){5,7}[a-fA-F\d]{1,4})|(::[a-fA-F\d]{1,4}))(\/128)?/;

    /** 日期，YYYY-MM-DD格式 */
    public static readonly DATE = /^((\d{2}(([02468][048])|([13579][26]))[-/\s]?((((0?[13578])|(1[02]))[-/\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[-/\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[-/\s]?((0?[1-9])|([1-2][0-9])))))|(\d{2}(([02468][1235679])|([13579][01345789]))[-/\s]?((((0?[13578])|(1[02]))[-/\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[-/\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[-/\s]?((0?[1-9])|(1[0-9])|(2[0-8]))))))(\s(((0?[0-9])|([1-2][0-3])):([0-5]?[0-9])((\s)|(:([0-5]?[0-9])))))?$/;
    /** 时间：HH:mm:SS */
    ...
    public static readonly MID_PASSWORD = /([a-zA-z\d]+|[a-zA-z`~!@#$%^&*()_\-+={}[\];:'"|/?,<>\\]+|[\d`~!@#$%^&*()_\-+={}[\];:'"|/?,<>\\]+)/;
    /** 强密码, 数字、字母和特殊字符组成 */
